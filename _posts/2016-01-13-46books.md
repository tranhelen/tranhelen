...
<div class="grid grid--full">
	<div class="grid__item push--one--two-twelfths one--eight-twelfths push--two--two-tenths two--six-tenths">
		...
		<h2 class="two--text-center">The 46; From Best to Worst</h2>

		<h3 class="two--text-center">The Best</h3>
...
<div class="grid grid--full">
	<h3 class="two--text-center">The Runners-Up</h3>
</div>
...
<div class="grid grid--full">
	<h3 class="two--text-center">The Okay</h3>
</div>
...
<div class="grid grid--full">
	<h3 class="two--text-center">The Wish-I-Quit</h3>
</div>
...
<div class="grid grid--full">
	<div class="grid__item push--one--two-twelfths one--eight-twelfths push--two--two-tenths two--six-tenths">
		...
		<h2 class="two--text-center">How to Read</h2>
